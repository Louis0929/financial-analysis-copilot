...
def configure_gemini():
    """
    Configure and initialize the Google Gemini 2.5 Pro model
    ...
    # Initialize and return the Gemini 2.5 Pro model (most advanced)
...
try:
    ...
    print("✅ Google Gemini 2.5 Pro model initialized successfully")
